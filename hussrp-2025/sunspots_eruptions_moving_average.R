...
ggplot(eruptions_filled, aes(x=YEAR)) +
  ...
  labs(title="Annual Significant Volcanic Eruptions (1600-2025) with 3-Year Moving Average",
     x="Year", y="Eruptions",
...
ggplot(sunspot_data, aes(x=year)) +
  ...
  geom_line(aes(y=ma3), size=1.2) +
  labs(title="Yearly Mean Sunspot Number (1700-2025) with 3-Year Moving Average",
     x="Year", y="Sunspots",
     caption="Gray=annual count, Blue=10-year moving average") +
  theme_minimal() +
  theme(text=element_text(family="Times New Roman"))
